function dy = membraneODE_withcon_bksk(t, y) %%%HAS EVERY CHANNEL EXCEPT FOR THE CALCIUM-DEP POTASSIUM
...
dy(1) = (elecparam(1) ... %external current
        ...
        - g(8)*y(16).*(y(17)^2).*(y(1)-e(2)))/elecparam(2); %CALCIUM-DEP POTASSIUM (BK) 
