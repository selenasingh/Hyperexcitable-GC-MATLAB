function dy = membraneODE_withcon_bksk(t, y) %%%BOTH CALCIUM-DEP CHANNELS IMPLEMENTED 
...
dy(1) = (elecparam(1) ... %external current
        ...
        - g(9)*(y(18)^2).*(y(1)-e(2)))/elecparam(2); ...%CALCIUM-DEP POTASSIUM (SK) [large conductance]
