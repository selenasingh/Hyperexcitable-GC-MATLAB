function dy = membraneODE_ca(t, y) %%%HAS EVERY CHANNEL EXCEPT FOR THE CALCIUM-DEP POTASSIUM
...
dy(1) = (elecparam(1) ... %external current
        ...
        - g(5)*(y(8)^2)*y(9).*(y(1)-100) ...%T-TYPE CALCIUM
        - g(6)*(y(10)^2)*y(11).*(y(1)-100) ...%N-TYPE CALCIUM 
        - g(7)*(y(12)^2).*(y(1)-100))/elecparam(2); %L-TYPE CALCIUM
else
